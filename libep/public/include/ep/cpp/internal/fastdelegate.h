...
// 24-Sep-15      * Fork by Euclideon, support C++11 variadic templates, other modern compiler fixes.
...
//   FastDelegate<void(int, char *, double)>
...
public:
	...
	FastDelegate(Y *pthis, DesiredRetType (X::* function_to_bind)(Args... args) ) {
	...
	template < class X, class Y >
	FastDelegate(const Y *pthis, DesiredRetType (X::* function_to_bind)(Args... args) const) {
	...
	FastDelegate(DesiredRetType (*function_to_bind)(Args... args) ) {
