  ...
  : UIComponent(pType, pKernel, uid, initParams)
{
  ...
  spCommandManager->RegisterCommand("showhideconsolewindow", Delegate<void(ActivityRef)>(this, &UIConsole::ToggleVisible), "", "", "`");
}

void UIConsole::ToggleVisible(ActivityRef activity)
{
