...
solution "epshell"
	...
	if _ACTION == "gmake" then
		configurations { "Release", "ReleaseQML", "Debug", "DebugOpt", "DebugQML", "ReleaseClang", "DebugClang", "DebugOptClang" }
		configuration { "*Clang" }
			toolset "clang"
		configuration {}
	else
		configurations { "Debug", "DebugOpt", "DebugQML", "Release", "ReleaseQML" }
		if _OS == "windows" then
