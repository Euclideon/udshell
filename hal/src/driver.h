...
# define EPKERNEL_DRIVER EPDRIVER_SDL
...
# define EPKERNEL_DRIVER EPDRIVER_PPAPI
...
# define EPKERNEL_DRIVER EPDRIVER_NULL
...
#if defined(EP_HEADLESS)
# undef  EPKERNEL_DRIVER
# define EPKERNEL_DRIVER EPDRIVER_NULL
# if defined(EP_WINDOWS)
#   undef  EPWINDOW_DRIVER
#   define EPWINDOW_DRIVER EPDRIVER_WIN32
# else
#   undef  EPWINDOW_DRIVER
#   define EPWINDOW_DRIVER EPDRIVER_NULL
# endif
...
# undef  USE_GLEW
# undef  EPKERNEL_DRIVER
# define EPKERNEL_DRIVER EPDRIVER_QT
# undef  EPWINDOW_DRIVER
